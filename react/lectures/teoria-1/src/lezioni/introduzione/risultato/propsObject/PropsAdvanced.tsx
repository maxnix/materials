...
const Article = ({ bgColor = 3, style, children, ...rest }: Props) => {
  console.log(rest.hide)
  // Destructuring & pass default value
  // let selectedColor = props.bgColor
  // if (selectedColor === undefined) {
  //   selectedColor = 3
  // }
  // const bgColor = availableColors[selectedColor - 1]
  const background = availableColors[bgColor - 1]
  return (
    <>
      <article
        style={{ marginBottom: `1rem`, backgroundColor: background, ...style }}
        className="card"
      >
        <img
...
export const PropsAdvancedObject = () => (
  <section className="flex flex-col place-items-center">
    ...
    <div className="flex mt-4 gap-4">
      <Article
        ...
        hide={false}
        secondChild={<TextContent title="Secondo figlio" subtitle="Ciao" />}
        style={{
